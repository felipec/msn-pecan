...
msn_error_get_text (unsigned int type)
{
    ...
    switch (type)
    {
        ...
        case 208:
            g_snprintf (msg, sizeof (msg),
                        _("Invalid screen name"));
            break;
        case 209:
            g_snprintf (msg, sizeof (msg),
                        _("Invalid friendly name"));
            break;
        case 210:
            g_snprintf (msg, sizeof (msg),
                        _("List full"));
        ...
        case 218:
            g_snprintf (msg, sizeof (msg),
                        _("Already in the mode"));
            break;
        case 219:
            g_snprintf (msg, sizeof (msg),
                        _("Already in opposite list"));
            break;
        case 223:
            g_snprintf (msg, sizeof (msg),
                        _("Too many groups"));
        ...
        case 231:
            g_snprintf (msg, sizeof (msg),
                        _("Tried to add a user to a group that doesn't exist"));
            break;
        case 280:
            g_snprintf (msg, sizeof(msg),
                        _("Switchboard failed"));
            break;
        case 281:
            g_snprintf (msg, sizeof (msg),
                        _("Notify transfer failed"));
            break;

        case 300:
            g_snprintf (msg, sizeof (msg),
                        _("Required fields missing"));
            break;
        case 301:
            g_snprintf (msg, sizeof (msg),
                        _("Too many hits to a FND"));
            break;
        case 302:
            g_snprintf (msg, sizeof (msg),
                        _("Not logged in"));
